                            ...
                            <table>
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td className="right-column">{new Date().getTime() > new Date(x.closureDate).getTime()?"You can't submmit":user&& x.submission.filter(z=>z.userId ==user?.id).length>0?<Link href={`/Student/NewArticle/${x.id}`} className='p-3 text-white bg-primary rounded-md'>Update</Link>:<Link href={`/Student/NewArticle/${x.id}`} className='p-3 text-white bg-primary rounded-md'>submit</Link>}</td>
                                    </tr>
                                    <tr>
